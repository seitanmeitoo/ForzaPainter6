    ...
    struct nk_image img, struct nk_color col)
{
    ...
    /* vinyl-painter patch: mode par defaut BLACKONWHITE accentue les noirs
     * lors du downscale et cree des contours gras sur les photos. HALFTONE
     * fait une moyenne ponderee correcte. SetBrushOrgEx requis par MSDN. */
    SetStretchBltMode(gdi.memory_dc, HALFTONE);
    SetBrushOrgEx(gdi.memory_dc, 0, 0, NULL);
